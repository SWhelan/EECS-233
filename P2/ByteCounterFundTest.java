...
public class  ByteCounterFundTest {
  ...
  ByteCounter byteCount = new ByteCounter("file.txt"); 
     byte b = (byte)'l';
        ...
        //Should log in the console that the file was not found and throw an IOException
        //ByteCounter byteCount2 = new ByteCounter("slfkdjdslkfj.txt"); 
 ...
 public void testSetOrder() {
     byte test [] = {(byte)'a', (byte)'b', (byte)'b'};
     ByteCounter byteCount = new ByteCounter(test);
     byteCount.setOrder("byte");
     String equals = ((int)'a' + ":1"+" "+ (int)'b'+":2");
     assertEquals("Method setOrder define the order of the current object", equals, byteCount.toString());
     byteCount.setOrder("countDec");
     String equals2 = ((int)'b'+":2"+" "+ (int)'a' + ":1");
     assertEquals("Method setOrder define the order of the current object", equals2, byteCount.toString());
     byteCount.setOrder("countInc");
     String equals3 = ((int)'a' + ":1"+" "+ (int)'b'+":2");
     assertEquals("Method setOrder define the order of the current object", equals3, byteCount.toString());
 }
 ...
 public void testFormatToString() {
     ...
     String equals = ('a' + ":1"+" "+'b'+":1");
     assertEquals("Method toString returns the bytes and their counts based on the format provided", equals, byteCount.toString("char"));
 }
}